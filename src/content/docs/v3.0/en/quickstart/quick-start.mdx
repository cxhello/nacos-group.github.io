...
您可以通过Nacos的[版本下载页面](/download/nacos-server/)、[release notes](https://github.com/alibaba/nacos/releases) 及 [发布声明](/news/release/)中找到每个版本支持的功能的介绍，`3.0.0`还处于Beta阶段，推荐在测试环境中使用，生产环境当前推荐的稳定版本为`2.5.1`.
